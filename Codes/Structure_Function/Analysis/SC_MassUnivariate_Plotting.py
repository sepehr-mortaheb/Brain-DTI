...
file_addr = op.join(
    res_dir,
    f'{atlas}/SC/MassUnivariate/Statistics_Cosmomnauts_LMM_PostPre_norm-{norm}.xlsx'
)
...
fig.savefig(
    op.join(
        res_dir,
        f'{atlas}/SC/MassUnivariate/Statistics_Cosmonauts_LMM_PostPre_norm-{norm}.pdf'
    ),
    dpi=300
)
fig.savefig(
    op.join(
        res_dir,
        f'{atlas}/SC/MassUnivariate/Statistics_Cosmonauts_LMM_PostPre_norm-{norm}.png'
    ),
    dpi=300
)
...
file_addr = op.join(
    res_dir,
    f'{atlas}/SC/MassUnivariate/Statistics_Controls_LMM_PostPre_norm-{norm}.xlsx'
)
df = pd.read_excel(file_addr)
...
fig.savefig(
    op.join(
        res_dir,
        f'{atlas}/SC/MassUnivariate/Statistics_Controls_LMM_PostPre_norm-{norm}.pdf'
    ),
    dpi=300
)
fig.savefig(
    op.join(
        res_dir,
        f'{atlas}/SC/MassUnivariate/Statistics_Controls_LMM_PostPre_norm-{norm}.png'
    ),
    dpi=300
)
...
file_addr = op.join(
    res_dir,
    f'{atlas}/SC/MassUnivariate/Statistics_Combined_LMM_PostPre_norm-{norm}.xlsx'
)
df = pd.read_excel(file_addr)
...
fig.savefig(
    op.join(
        res_dir,
        f'{atlas}/SC/MassUnivariate/Statistics_Combined_LMM_PostPre_norm-{norm}.pdf'
    ),
    dpi=300
)
fig.savefig(
    op.join(
        res_dir,
        f'{atlas}/SC/MassUnivariate/Statistics_Combined_LMM_PostPre_norm-{norm}.png'
    ),
    dpi=300
)